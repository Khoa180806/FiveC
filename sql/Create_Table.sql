...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa CUSTOMER');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa TABLE_FOR_CUSTOMER');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa PAYMENT_METHOD');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa CATE');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa USER_ACCOUNT');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('- Đã xóa USER_ROLE');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
