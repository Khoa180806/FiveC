 ...
 * @author Asus
 */
public class ReportManagementJDialog extends javax.swing.JFrame {

    /**
     * Creates new form ReportJDialog
     */
    public ReportManagementJDialog() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportManagementJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportManagementJDialog().setVisible(true);
            }
        });
    }
